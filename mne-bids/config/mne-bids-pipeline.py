...
#   #  5: high voltage → peak2peak rejection before ICA removes all epochs
#   # 20: high voltage → peak2peak rejection before ICA removes all epochs
#   # 29: high voltage → peak2peak rejection before ICA removes all epochs
...
epochs_tmin: float = -1.0 # equal to original publication
"""
...
epochs_tmax: float = 4.0 # final two seconds are skipped
"""
