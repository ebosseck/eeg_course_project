...
subjects: Union[Iterable[str], Literal["all"]] = ['01']
# """
...
drop_channels: Iterable[str] = ["EOG", "BIP1", "BIP2", "BIP3", "BIP4", "BIP5", "BIP6", "BIP7", "BIP8", "BIP9", "BIP10", "BIP11", "BIP12", "BIP13", "BIP14", "BIP15", "BIP16", "BIP17", "BIP18", "BIP19", "BIP20", "BIP21", "BIP22", "BIP23", "BIP24"]
# """
...
time_frequency_baseline: Optional[Tuple[float, float]] = (-0.2, 0)
# """
